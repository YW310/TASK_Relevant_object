...
- 3D fusion/tracking: CLUSTER_DISTANCE_M, TRACK_MAX_MISSED_FRAMES, TRACK_MAX_SIZE_RATIO, MIN_FUSED_POINTS, MIN_BBOX_DIAGONAL_M, MAX_CENTROID_TO_CLOUD_DISTANCE_M
