...
#     COMPILE_MODEL, TOP_K_PER_SEMANTIC_GROUP, CANDIDATE_POOL_SIZE, MIN_MASK_AREA,
...
#     DECISION_VIZ_ANNOTATION_ALPHA, DECISION_VIZ_HIDE_SUSPECTED_FRAGMENTS.
...
TOP_K_PER_SEMANTIC_GROUP="${TOP_K_PER_SEMANTIC_GROUP:-8}"
...
if [[ "${SKIP_CANDIDATES}" == "1" ]]; then
  ...
  STAGE1_ARGS=(
    ...
    --top-k-per-semantic-group "${TOP_K_PER_SEMANTIC_GROUP}"
